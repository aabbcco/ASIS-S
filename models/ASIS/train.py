...
parser.add_argument('--input_list', type=str, default='data/train_hdf5_file_list_woArea8.txt', help='Input data list file')
...
for h5_filename in train_file_list:
    cur_data, cur_group, _, cur_sem = provider.loadDataFile_with_groupseglabel_stanfordindoor(os.path.join(ROOT_DIR,h5_filename))
