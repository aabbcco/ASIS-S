...
TF_ROOT=/home/david/anaconda3/envs/sgl/lib/python3.6/site-packages/tensorflow
/usr/local/cuda-10.0/bin/nvcc -std=c++11 -c -o tf_sampling_g.cu.o tf_sampling_g.cu -O2 -DGOOGLE_CUDA=1 -x cu -Xcompiler -fPIC
#TF 1.5
